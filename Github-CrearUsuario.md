...
1. Primero ingresamos al siguiente link **"https://github.com/".**
   ...
   1. En la esquina superior derecha encontraremos el botón de **sign up** le damos clic.
...
<img src="https://www.mclibre.org/consultar/informatica/img/git/github-crear-cuenta-03.png" width="800px">
   ...
   1. Nos preguntará si queremos recibir información por correo si la respuesta es si colocamos "y" en caso contrario colocamos "n".

   1. Para verificar nuestra cuenta nos pedirá resolver un ejercicio donde debemos identificar dos objetos iguales dentro de una imágen.

   1. Por último damos en crear cuenta y nos pedirá un *código que llegara a nuestro correo electrónico.*
-----------------------------------------------------------------------------------------------------
<h2>Crear un repositorio en GitHub</h2>

1. Para *crear un repositorio* debemos ingresar a nuestra cuenta.

1. En la izquierda tenemos una barra lateral donde abajo de la barra de navegación dice **"top repositories"** a un lado de ese título hay un botón verde que dice *NEW o NUEVO*, le damos clic.
...
2. Da la opción de elegir si es un repositorio público o uno privado, damos clic dependiendo de cuál sea el caso.
...
1. Nos pedirá los siguientes datos:
- Nombre del token, es para ubicar para que lo creamos
- Fecha de expiración
- Opciones de scopes

1. Damos clic en generar y nos generará un token
